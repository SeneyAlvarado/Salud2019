...
<body class="bg-color">
	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<div><a href="{{ url('citas') }}"><img class="img-responsive" style="margin-top: 10px; margin-left: 80px;" class=""
			...
			<div id="sidebar-wrapper" class="sidebar-toggle sidebar">
				...
				<ul class="sidebar-nav">
					<li>
						<a class="border" href="{{ url('citas')}}">Citas<span
								class="glyphicon glyphicon-calendar right-citas"></a>
					</li>

					<li>
						<a class="border" href="{{ url('perfilPaciente')}}">Perfil<span
								class="glyphicon glyphicon-user right-perfil"></a>
					</li>
					<li>
						<a class="border" href="{{ url('cambioContrasenna')}}">Contraseña<span
								class="glyphicon glyphicon-lock right-aling-lock"></a>
					</li>
					<li class="hide-button-side">
						<a href="{{ url('/logout') }}" class="border">Salir<span
	...
	<div class="sidebar-mobile">
		...
		<div id="myNavbar" class="collapse">
			<a class="border-a" href="{{ url('citas')}}">Citas<span
					class="glyphicon glyphicon-calendar right-citas"></a>
			<a class="border-a" href="{{ url('perfilPaciente')}}">Perfil<span
					class="glyphicon glyphicon-user right-perfil"></a>
			<a class="border-a" href="{{ url('cambioContrasenna')}}">Contraseña<span
					class="glyphicon glyphicon-lock right-aling-lock"></a>
			<a href="{{ url('/logout') }}" class="border-a hide-button-exit">Salir<span
					class="glyphicon glyphicon-log-out right-salir"></a>
		</div>
	</div>
